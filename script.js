...
(function () {
  ...
  const animSeq = ['panLeft','panUp','none','panUp','panRight','zoomOut','panRight','none'];
...
(function () {
  ...
  function openPanel() {
    ...
    close?.focus();
    // Carga diferida: inyectar iframe Vimeo solo la primera vez
    if (!vimeoLoaded) {
      vimeoLoaded = true;
      const wrap = document.getElementById('feedVimeoWrap');
      if (wrap) {
        const iframe = document.createElement('iframe');
        iframe.src = 'https://player.vimeo.com/video/1200016508?title=0&byline=0&portrait=0&badge=0&autopause=0&player_id=0&app_id=58479&autoplay=1&muted=1';
        iframe.frameBorder = '0';
        iframe.allow = 'autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share';
        iframe.referrerPolicy = 'strict-origin-when-cross-origin';
        iframe.style.cssText = 'position:absolute;top:0;left:0;width:100%;height:100%;';
        iframe.title = 'LA ESCUELA NOCTURNA REMAKE';
