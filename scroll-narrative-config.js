...
window.SCROLL_NARRATIVE_CONFIG = [

  {
    ...
    description: '',
    background: { type: 'image', src: "./1.webp" }, // e.g. './images/narrative/stop1-bg.webp'
    layers: [
      { src: "./1.1.png", depth: 2 }, // far — distant skyline
      { src: "./1.2.png", depth: 4 }, // mid — mid-ground rooftops
      { src: "./1.3.png", depth: 6 }, // near — foreground streetlamp/wire, zoom más intenso
    ],
  },
  {
    header: 'Calles que caminé',
    description: '',
    background: { type: 'image', src: "./2.webp" },
    layers: [
      { src: null, depth: 2 }, // far
      { src: null, depth: 4 }, // mid
      { src: null, depth: 6 }, // near
    ],
  },
  {
    header: 'El estudio',
    description: '',
    background: { type: 'image', src: "./3.webp" },
    layers: [
      { src: null, depth: 2 }, // far
      { src: null, depth: 4 }, // near
    ],
  },
];